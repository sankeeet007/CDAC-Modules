...
class GrandChild:public Child{
 ...
 public:
	 GrandChild(){
	   cout<<"Default grandchild constructor"<<endl;
	   g1=0;
	 }
	 GrandChild(int p1,int p2,int c1,int c2,int g1):Child(p1,p2,c1,c2){
            cout<<"in grandchild parametrized constructor"<<endl;		 
	    this->g1=g1;
	 }
	 void display(){
	    Child::display();
